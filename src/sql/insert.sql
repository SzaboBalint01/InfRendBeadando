...
VALUES (345,"KA_mini","HKB-661","FORD","1G1ZC5E08CF148007",'2020-01-09-04-22-38',5000,100,0);
INSERT INTO `bead_db`.`jarmu`
(`tipus`,`rendszam`,`gyarto`,`alvazszam`,`beszerzesidatum`,`kolcsonzesidij`,`futottkmdij`,`statusz`) 
VALUES ("Spark","312-NSN","Chevrolet","KNDJF723X67268993",'2020-02-10-06-55-01',5100,95,1);
INSERT INTO `bead_db`.`jarmu`
(`tipus`,`rendszam`,`gyarto`,`alvazszam`,`beszerzesidatum`,`kolcsonzesidij`,`futottkmdij`,`statusz`) 
VALUES ("Wagon","ACR-101","Suzuki","5UXWX5C58CL719234",'2020-02-21-00-32-45',4950,105,0);
INSERT INTO `bead_db`.`jarmu`
(`tipus`,`rendszam`,`gyarto`,`alvazszam`,`beszerzesidatum`,`kolcsonzesidij`,`futottkmdij`,`statusz`) 
VALUES ("Swift","AEK-950","Suzuki","1J8FT28W68D760789",'2020-04-08-08-42-33',4500,115,2);
INSERT INTO `bead_db`.`jarmu`
(`tipus`,`rendszam`,`gyarto`,`alvazszam`,`beszerzesidatum`,`kolcsonzesidij`,`futottkmdij`,`statusz`) 
VALUES ("742CU","H-12421","Bayliner","1G1PA5SH0E7260515",'2020-04-17-01-58-42',20000,200,1);
INSERT INTO `bead_db`.`jarmu`
(`tipus`,`rendszam`,`gyarto`,`alvazszam`,`beszerzesidatum`,`kolcsonzesidij`,`futottkmdij`,`statusz`) 
VALUES ("Antares 6OB","H-12532","Beneteau","1HD1KB415AB626001",'2020-04-21-05-17-15',25000,250,0);
...
VALUES(1,'2020-05-14-03-05-39',346,1);
INSERT INTO `bead_db`.`kolcsonzes` (`idkolcsonzes`,`kolcsonzesideje`,`jarmu`,`ugyfel`) 
VALUES(2,'2020-05-15-06-06-45',349,3);